...
import (
    "testing"
    "github.com/HelixDevelopment/HelixPlay/cmd/core"
)

func TestGRPCDiscovery(t *testing.T) {
    d := core.NewDiscovery("host-agent", "localhost:50051")
...
func TestProtocolNegotiation(t *testing.T) {
    n := core.NewNegotiator()
    clientCaps := core.Capabilities{
        Codecs:     []string{"H.264", "HEVC"},
        Resolutions: []string{"1080p", "4K"},
        MaxFPS:     120,
    }
    serverCaps := core.Capabilities{
